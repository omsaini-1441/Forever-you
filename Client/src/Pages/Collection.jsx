...
const Collection = () => {
  // Extracting necessary values from context
  const { products, search, showSearch } = useContext(ShopContext);

  // State variables to manage filters, categories, and sorting
  ...
  const applyFilter = () => {
    ...
    // Filtering by selected subcategories
  ...
  // Apply filter whenever category, subcategory, search, or showSearch changes
  useEffect(() => {
    applyFilter();
